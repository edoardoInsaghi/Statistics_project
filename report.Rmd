...
```{r dimensionality reduction, echo=FALSE, fig.width=8, fig.height=5}
...
```{r dimensionality reduction2, echo=FALSE, fig.width=12, fig.height=8}
...
```{r categorical variables2, echo=FALSE, fig.width=11, fig.height=8}
