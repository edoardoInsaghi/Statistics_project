...
This project aims to develop statistical models capable of predicting house sale prices (it's then a regression task) from a set of covariates describing every aspect of the property.
